...
predef_board_t boards[15] = {
    { .initial_points = 6, .cities = 8, .i = (int[]){1,9,7,4,2,2,2,10}, .j = (int[]){12,7,17,6,0,9,12,12}, .pop = (int[]){2,10,4,6,5,2,6,3} },
    { .initial_points = 4, .cities = 5, .i = (int[]){7,1,10,6,1}, .j = (int[]){16,8,7,17,7}, .pop = (int[]){9,5,7,5,1} },
    { .initial_points = 6, .cities = 7, .i = (int[]){3,8,5,0,11,10,1}, .j = (int[]){1,5,9,16,17,0,12}, .pop = (int[]){4,5,6,1,9,5,8} },
    ...
    { .initial_points = 6, .cities = 7, .i = (int[]){0,2,8,5,10,3,6}, .j = (int[]){1,9,14,16,4,7,11}, .pop = (int[]){6,7,11,6,8,4,5} },
    { .initial_points = 4, .cities = 8, .i = (int[]){5,3,6,9,10,1,0,11}, .j = (int[]){17,7,0,3,13,1,14,11}, .pop = (int[]){5,8,7,9,5,3,6,4} },
    { .initial_points = 5, .cities = 7, .i = (int[]){3,9,0,4,8,10,6}, .j = (int[]){11,1,15,3,6,8,17}, .pop = (int[]){6,14,8,7,5,5,9} },
    { .initial_points = 8, .cities = 5, .i = (int[]){1,11,0,5,3}, .j = (int[]){1,15,13,5,9}, .pop = (int[]){10,2,3,7,3} },
    { .initial_points = 5, .cities = 6, .i = (int[]){2,7,5,0,9,4}, .j = (int[]){17,4,9,11,2,6}, .pop = (int[]){9,5,8,7,3,6} },
    { .initial_points = 4, .cities = 8, .i = (int[]){10,2,4,0,6,11,1,7}, .j = (int[]){16,2,10,5,8,13,17,6}, .pop = (int[]){1,6,8,4,7,8,3,5} },
    { .initial_points = 5, .cities = 6, .i = (int[]){0,3,11,2,8,5}, .j = (int[]){9,5,12,15,7,1}, .pop = (int[]){9,8,10,5,6,3} },
    { .initial_points = 6, .cities = 7, .i = (int[]){4,10,1,0,3,6,5}, .j = (int[]){14,9,3,13,6,1,7}, .pop = (int[]){5,1,10,12,4,6,2} },
    { .initial_points = 6, .cities = 5, .i = (int[]){2,8,1,11,7}, .j = (int[]){12,6,1,4,13}, .pop = (int[]){6,3,7,11,8} },
    { .initial_points = 5, .cities = 7, .i = (int[]){5,2,11,4,1,6,0}, .j = (int[]){2,10,14,7,16,12,6}, .pop = (int[]){4,7,3,9,6,5,2} }
};
